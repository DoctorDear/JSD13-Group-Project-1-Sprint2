...
const HERO =
  "https://plus.unsplash.com/premium_photo-1747429964769-d12808b90e9d?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D";
...
export default function Login() {
  ...
  const f = useForm({ email: "", password: "" }, schema, async (values, { signal }) => {
    ...
    goToSite(state?.from?.pathname || "/"); // back to the main website
  });
