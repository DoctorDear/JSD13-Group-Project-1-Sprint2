        ...
        <div className="border border-gray-200 rounded-lg p-3 mb-6 bg-gray-50">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <svg
                className={`w-4 h-4 transition-transform ${isSummaryOpen ? "rotate-180" : ""}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          <div className="border border-blue-400 rounded-lg overflow-hidden bg-gray-50/30">
            ...
            <div className="p-3 border-b border-gray-200 flex items-center justify-between hover:bg-gray-50 cursor-pointer">
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="px-1.5 py-0.5 bg-blue-800 text-white text-[10px] font-bold rounded">
                  AMEX
                </span>
              </div>
            </div>
            ...
            <div className="p-3 border-b border-gray-200 flex items-center justify-between hover:bg-gray-50 cursor-pointer">
              ...
              <div className="flex items-center gap-1">
                <span className="px-1.5 py-0.5 bg-red-700 text-white text-[10px] font-bold rounded">
                  UnionPay
                </span>
                <span className="px-1.5 py-0.5 bg-blue-900 text-white text-[10px] font-bold rounded">
                  THAI QR
                </span>
              </div>
            </div>
