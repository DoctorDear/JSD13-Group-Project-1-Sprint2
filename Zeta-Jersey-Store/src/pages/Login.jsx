    ...
    <div className="min-h-screen w-full bg-gradient-to-br from-[#3A0CA3] via-[#6432D4] to-[#7B7BFF] flex items-center justify-center p-5 sm:p-8 lg:p-12">
      <div className="w-full max-w-6xl">
        ...
        <div className="lg:hidden mb-8 px-2">
          ...
          <p className="mt-3 text-white text-lg font-medium">Please enter your details</p>
        </div>
        ...
        <div className="bg-white rounded-[32px] shadow-2xl p-4 lg:p-5 lg:grid lg:grid-cols-2 lg:gap-10">
          ...
          <div className="relative hidden lg:block rounded-3xl overflow-hidden min-h-[620px]">
            <img
              src="https://plus.unsplash.com/premium_photo-1747429964769-d12808b90e9d?q=80&w=1587&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              alt="Football fan sitting in stadium seats"
          ...
          <div className="flex flex-col justify-center p-4 sm:p-6 lg:py-8 lg:pr-6">
            {/* Desktop heading */}
            <h1 className="hidden lg:block text-6xl font-extrabold tracking-tight text-black drop-shadow-sm">
              Log in
            </h1>
            ...
            <form className="lg:mt-12" onSubmit={handleSubmit}>
              ...
              <Link
                to="/reset-password"
                className="mt-5 lg:mt-7 inline-block text-gray-900 underline underline-offset-2 lg:no-underline hover:underline"
              >
                Forget Password ?
              </Link>
              ...
              <button
                type="submit"
                className="mt-4 lg:mt-5 w-full rounded-lg bg-[#1E0A73] py-4 text-lg font-semibold text-white hover:bg-[#2A0F7A] focus:outline-none focus:ring-4 focus:ring-[#2A0F7A]/30 transition"
              >
                Log in
              </button>
            </form>
